          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="group flex items-center gap-3 rounded-full border border-slate-200 bg-white p-1 pr-4 transition-all hover:border-brand-purple/40 hover:shadow-md outline-none">
                <div className="relative flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-tr from-slate-100 to-slate-200 text-slate-500 group-hover:from-brand-cyan group-hover:to-brand-purple group-hover:text-white transition-all overflow-hidden font-bold text-xs">
                  {user?.avatar ? (
                    // 2. Ganti img ke Image Next.js
                    <Image 
                      src={user.avatar} 
                      alt="profile" 
                      fill 

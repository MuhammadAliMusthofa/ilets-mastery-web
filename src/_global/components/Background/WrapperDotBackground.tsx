...
interface WrapperDotBackgroundProps extends React.HTMLAttributes<HTMLDivElement> {
  children: React.ReactNode;
}

export function WrapperDotBackground({ 
  children, 
  className, 
  ...props 
}: WrapperDotBackgroundProps) {
  return (
    // 1. Base Wrapper
    <div 
    ...
    >
      ...
      <div className="absolute inset-0 bg-dot bg-[size:1.5rem_1.5rem]" />

...
export default function UnitDetailContainer({ skill, unitId }: UnitDetailProps) {
  // Hapus atau gunakan variabel ini jika perlu. Untuk sementara saya biarkan tapi pastikan dipakai.
        ...
        <div className="bg-emerald-50 border border-emerald-100 p-6 rounded-2xl flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-emerald-700 text-sm font-medium">
              {"Perhatikan judul bagian (jika ada) dan instruksi soal, misalnya "} 
              <span className="underline decoration-emerald-300 font-bold text-emerald-800">
                {"\"Write NO MORE THAN TWO WORDS\""}
              </span>
              {". Seringkali jebakan ada di instruksi ini."}
            </p>
          </div>
        </div>
      </Card>

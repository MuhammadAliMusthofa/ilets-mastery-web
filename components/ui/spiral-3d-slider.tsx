...
export interface Spiral3DSliderProps {
  ...
  ariaLabel?: string;
  /** Largest image width as a fraction of the stage width. */
  maxWidthRatio?: number;
  /** Largest spiral radius as a fraction of the stage width. */
...
function SpiralScene({
  items,
  // Ref dinamai berakhiran "Ref" agar lint proyek mengenalinya sebagai ref,
  // bukan prop biasa yang tidak boleh dimutasi.
  ...
  useFrame((_state, delta) => {
    ...
    const planeWidth = Math.min(cardWidth / factor, viewport.width * maxWidthRatio);
